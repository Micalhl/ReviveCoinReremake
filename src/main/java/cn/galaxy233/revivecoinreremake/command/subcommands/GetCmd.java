...
public class GetCmd extends BaseCommand {
    ...
    protected void call(String[] args) {
        try {
            ItemStack itemStack = Configuration.REVIVE_COIN;
            itemStack.setAmount(Integer.parseInt(args[0]));

            String getMsg = info(plugin.lang.getRaw(plugin.localeKey, "Lang", "successful-get-reviveCoin"));
            ...
            if (!out.isEmpty()) {
                String msg = plugin.lang.getRaw(plugin.localeKey, "Lang", "inventory-is-full");
